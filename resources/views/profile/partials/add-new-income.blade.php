<section class="space-y-6">
    ...
    <div class="grid md:grid-cols-2 md:gap-6">
        ...
        <div class="relative overflow-x-auto z-0 w-full mb-5 group max-h-60 ">
            ...
            <label for="incomeSpecialNoteInCreateIncome" class="block mb-2 text-sm font-medium text-gray-900 dark:gray-900">Special note</label>
            <textarea id="incomeSpecialNoteInCreateIncome" name="incomeSpecialNoteInCreateIncome" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500 h-40" placeholder=""></textarea>
    ...
    <script src="{{ asset('js/incomeAddDropdownHandler.js') }}"></script>
